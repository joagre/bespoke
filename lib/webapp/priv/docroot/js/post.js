...
const Post = (function () {
  ...
  async function _loadData() {
    ...
    try {
      ...
      Bespoke.markAsRead(_parentPost.id);
      ...
      if (_parentPost.author !== Bespoke.getCookieValue("username")) {
  ...
  function _populatePage() {
    ...
    document.getElementById("parent-title").innerHTML = _topPostTitle;
    ...
    document.getElementById("parent-body").innerHTML = Bespoke.formatMarkdown(_parentPost.body);
