    ...
    if (post.attachments.length > 0) {
      ...
      for (const attachment of post.attachments) {
        ...
        if (attachment.contentType.startsWith("image/")) {
          item = html`<div uk-lightbox>
            <a href="${absPath}" data-caption="${attachment.filename}">
              <img class="attachment" src="absPath" alt="">
            </a>
          </div>`;
      ...
      attachments = render(html`<div class="uk-position-relative" uk-slider>
        <div id="attachments" class="uk-slider-items">
          ${items}
        </div>
