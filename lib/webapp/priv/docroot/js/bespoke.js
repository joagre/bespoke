...
class Bespoke {
  ...
  navigateTo(destination) {
    this.setRawLocalItem("previousPage", destination);
  ...
  initializeMobileKeyboardResizing(id) {
    ...
    resizeBody();
    // Block scrolling outside of "form-body" textarea in case the
    // "overscoll-behaivor: contain;" is'nt supported, i.e. on iOS
    // and Safari.
